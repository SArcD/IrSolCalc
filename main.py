...
tile_size = (6000, 6000)  # Dimensiones del mosaico ACE2 (9 arcseconds)
geojson_path = "Colima.json"  # Archivo GeoJSON de Colima
cloud_data_path = "nubes_2021a22.csv"  # Archivo CSV con datos de nubosidad
...
# Cargar los datos de nubosidad
try:
    cloud_data = pd.read_csv(cloud_data_path)
    st.write("Datos de nubosidad cargados correctamente.")
except Exception as e:
    st.error(f"Error al cargar el archivo de nubosidad: {e}")
    st.stop()
...
def get_ncloud(row, cloud_data):
    ...
    return closest_cloud["ANN"] / 100  # Normalizar el porcentaje de nubosidad
